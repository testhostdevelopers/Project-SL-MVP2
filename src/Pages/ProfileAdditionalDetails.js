...
import ProfileCheck from "../assets/img/icons/custom/profile-check.png";
                            ...
                            <div className="position-relative">
                                ...
                                <div className="profile-info-position">
                                    <div className="profile-user-pictures">
                                        ...
                                        <span className="profile-check-icon"><img src={ProfileCheck} /></span>
                                    </div>
                                    <div className="mt-3 profile-usr-name-h3-size">
                                        <h3><b>Arlene McCoy</b></h3>
                                        <h4 className="pro-username">@pixeldrops</h4>
                        ...
                        <main className="profile-tab-menu">
                            ...
                            <Tabs defaultActiveKey="4" centered>
                                <TabPane tab="On sole" key="1">
                                    <div className="row mb-5 liveAuction">
