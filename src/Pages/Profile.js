                                    ...
                                    <div className="topSeller">
                                        <div className="container-fluid">
                                            ...
                                            <div className="topSellerContent">
                                                <div className="row">
                                                <div className="d-flex col-lg-9 activity">
                                                    <TopCard topcoverimg={topSeller4} topuserimg={topSellerUser1} title="Courtney Henry" follow="Started following you" datetime="8/8/2021, 3:57 PM" Price="$1,403"  />
                                                    <TopCard topcoverimg={topSeller3} topuserimg={topSellerUser3} title="Courtney Henry" follow="Started following you" datetime="8/8/2021, 3:57 PM" Price="$1,403"  />
                                                    <TopCard topcoverimg={topSeller4} topuserimg={topSellerUser4} title="Courtney Henry" follow="Started following you" datetime="8/8/2021, 3:57 PM" Price="$1,403"  />
                                                </div>                                                
                                    ...
                                    <div className="topSeller">
                                        <div className="container-fluid">
                                            ...
                                            <div className="topSellerContent">
                                                <div className="row">
                                                <div className="d-flex col-lg-9 activity">
                                                    <TopCard topcoverimg={topSeller4} topuserimg={topSellerUser1} title="Courtney Henry" follow="Started following you" datetime="8/8/2021, 3:57 PM" Price="$1,403" btnname="Unfollow" />
                                                    <TopCard topcoverimg={topSeller3} topuserimg={topSellerUser3} title="Courtney Henry" follow="Started following you" datetime="8/8/2021, 3:57 PM" Price="$1,403" btnname="Unfollow" />
                                                    <TopCard topcoverimg={topSeller4} topuserimg={topSellerUser4} title="Courtney Henry" follow="Started following you" datetime="8/8/2021, 3:57 PM" Price="$1,403" btnname="Unfollow" />
                                                </div>
